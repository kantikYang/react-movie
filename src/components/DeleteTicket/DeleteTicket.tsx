...
export const DeleteTicket = ({ id }: { id: string }) => {
  console.log('dsbdfsgdsg');
  // const dispatch = useDispatch();

  // const handleYesClick = () => {
  //   // Здесь выполняется ваша функция
  //   // Например, dispatch(yourAction())
  // }; // добавьте все зависимости, которые используются в вашей функции

  // const handleNoClick = () => {
  //   // Здесь закрывается модальное окно
  //   // Например, dispatch(closeModal())
  // }; // добавьте все зависимости, которые используются в вашей функции

  // useEffect(() => {
  //   // Здесь вы можете добавить любые действия, которые должны произойти при монтировании компонента
  // }, []);

  return (
    <div className={style.popUpBg} id="popUp">
      <div className={style.popUp}>
        <div className={style.popUpTitle}>
          <p>Удаление билета</p>
          <div className={style.popUpClose}>{closeBtn}</div>
        </div>
        <div className={style.popUpText}>
          <p>Вы уверены, что хотите удалить билет?</p>
        </div>
        <div className={style.popUpAllBtn}>
          <button className={`${style.popUpBtn} ${style.popUpBtnYes}`}>
            Да
          </button>
          <button className={`${style.popUpBtn} ${style.popUpBtnNo}`}>
            Нет
          </button>
        </div>
      </div>
